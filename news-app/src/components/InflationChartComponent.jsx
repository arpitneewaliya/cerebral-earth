...
const InflationChartComponent = ({ countryName, countryCode, start = 2000, end = 2023, isDarkMode }) => {
  ...
  const fetchChart = async () => {
    ...
    try {
      ...
      if (response.ok && data.imageBase64) {
        ...
        setError('Inflation chart generation failed. Please try again.');
      }
    } catch (err) {
      ...
      {imageBase64 ? (
        <div className={`rounded-lg overflow-hidden border ${
          ...
          <img
            ...
            alt={`Inflation Chart of ${countryName}`}
